<x-guest-layout>
    <form method="POST" action="{{ route('registerVendorStore') }}" enctype="multipart/form-data">
        <h1 class="text-center font-medium text-gray-700">Register as Vendor</h1>
        @csrf
        ...
        <div class="mt-4">
            ...
            <input id="foto"
                class="bg-white p-1 block mt-1 w-full text-black border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
